...
# Converted to odoo 15 - Vasil Kaliuta
# License AGPL-3.0 or later (https://www.gnu.org/licenses/agpl).
{
    ...
    'assets': {
        'web.assets_frontend': [
            ...
            'website_sale_product_minimal_price/static/src/js/website_sale_product_minimal_price.js',
            ...
            'website_sale_product_minimal_price/static/src/js/test_product_with_no_prices_tour.js',
        ],
    },
}
